...
class Router
{
    ...
    /**
     * @var object|callable The function to be executed when home is called
     */
    protected $HandlerHome;
    ...
    public function run($callback = null)
    {
        ...
        // If home route was handled, trigger the home (if any)
        if ($numHandled === 0) {
            if ($this->HandlerHome) {
                $this->invoke($this->HandlerHome);
            } else {
    ...
    /**
     * Set the home handling function.
     *
     * @param object|callable $fn The function to be executed
     */
    public function homeHandler($fn)
    {
        $this->HandlerHome = $fn;
    }
